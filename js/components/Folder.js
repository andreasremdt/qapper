    ...
    >
      <summary className="flex items-center cursor-pointer p-4">
        ...
        <Button
          ...
          className="mr-3"
          href={`/testcases/${testCase.id}/edit`}
        />
        <Button
          variant="danger"
          icon="trash"
      ...
      <ul className="border-t border-solid border-gray-300">
        <li className="border-b border-solid border-gray-300">
          ...
          >
            <Icon icon="file" width="16" height="16" className="mr-2" /> Chrome
            on SaaS
            <span className="ml-auto text-sm text-gray-500">90% completed</span>
          </Link>
        </li>
        <li className="border-b border-solid border-gray-300">
          <Link
          ...
          >
            ...
            <span className="ml-auto text-sm text-gray-500">0% completed</span>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            <Icon icon="file" width="16" height="16" className="mr-2" />
            Firefox on SaaS
            <span className="ml-auto text-sm text-gray-500">11% completed</span>
          </Link>
        </li>
      </ul>
    </details>
